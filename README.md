...
1. Ensure you have an [Goerli L1 node RPC](https://docs.base.org/tools/node-providers) available, and set `OP_NODE_L1_ETH_RPC` (in `docker-compose.yml` if using docker-compose).
2. Run:
```
docker compose up
```
